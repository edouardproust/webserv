...
//	Response response2 = StaticHandler::handleError(HttpStatus("not_found")); signature function will prob change
//	std::cout << response2.stringify() << std::endl;

	std::cout << "\n---Test 3: 200 OK, with no body---" << std::endl << std::endl ;
	Response response3;
	response3.setStatus(HttpStatus("ok"));
...
//	Response response4 = StaticHandler::handleError(HttpStatus("internal_server_error")); signature function will prob change
//	std::cout << response4.stringify() << std::endl;

	std::cout << "\n---Test 5: 200 OK, random header---" << std::endl << std::endl ;
	Response response5;
	response5.setStatus(HttpStatus("ok"));
	...
	Response response6;
	response6.setStatus(HttpStatus("ok"));
	...
	Response response7;
	response7.setStatus(HttpStatus("ok"));
